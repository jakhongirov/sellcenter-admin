...
function ForkliftMarks() {
  ...
  const [ForkliftMarksList, setForkliftMarksList] = useState({
    isFetched: false,
    data: {},
    err: false,
  });
        ...
        <div className="container">
          ...
          <div className="table_wrap ">
            <AddModal
              ...
              name={"mark_name"}
              api={"forklift/add/mark"}
            />
            <DeleteModal
              deleteModal={deleteModal}
              setDeleteModal={setDeleteModal}
              api={"forklift/delete/mark"}
              id={"mark_id"}
            ...
            <table>
              ...
              <tbody>
                {ForkliftMarksList.data?.map((forklift, index) => (
                  <tr key={index} className="table_tr">
                    <td>{forklift.forklift_make_id}</td>
                    ...
                    <td className="btns">
                      ...
                      <Link
                        to={`/forklift/marks/${forklift.forklift_make_name}/${forklift.forklift_make_id}`}
                      >
