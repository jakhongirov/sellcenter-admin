        ...
        <div className="container">
          ...
          <div className="table_wrap ">
            <AddModels
              ...
              id={truckList.data[0]?.truck_make_id}
              name={"model_name"}
              api={"truck/add/model"}
            />
            <EditModels
            ...
            <table>
              ...
              <tbody>
                {truckList.data?.map((truck, index) => (
                  <tr key={index} className="table_tr">
                    <td>{truck.truck_model_id}</td>
                    <td>{truck.truck_model_name}</td>
                    ...
                    <td className="btns">
                      <button
                        ...
                        onClick={() => {
                          setEditModal(true);
                          setSelectedMotorcycleMakeName(truck.truck_model_name);
                          setSelectedMotorcycleModelId(truck.truck_model_id);
                        }}
                      >
...
export default SingleTruckMarks;
