              ...
              <tbody>
                {VanList.data?.map((van, index) => (
                  <tr key={index} className="table_tr">
                    <td>{van.van_model_id}</td>
                    <td>{van.van_model_name}</td>
                    ...
                    <td className="btns">
                      <button
                        ...
                        onClick={() => {
                          setEditModal(true);
                          setSelectedMotorcycleMakeName(van.van_model_name);
                          setSelectedMotorcycleModelId(van.van_model_id);
                        }}
                      >
