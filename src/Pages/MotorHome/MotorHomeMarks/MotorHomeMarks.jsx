        ...
        <div className="container">
          ...
          <div className="table_wrap ">
            <AddModal
              ...
              name={"mark_name"}
              api={"motorhome/add/mark"}
            />
            <DeleteModal
              deleteModal={deleteModal}
              setDeleteModal={setDeleteModal}
              api={"motorhome/delete/mark"}
              id={"mark_id"}
              ...
              <tbody>
                {motorhomeList.data?.map((motorhome, index) => (
                  <tr key={index} className="table_tr">
                    <td>{motorhome.motor_home_make_id}</td>
                    <td>{motorhome.motor_home_make_name}</td>
                    <td></td>
                    <td></td>
                    <td className="btns">
                      <button
                        ...
                        onClick={() => {
                          ...
                          setSelectedMotorcycleMakeName(
                            motorhome.motor_home_make_name
                          );
                          setSelectedMotorcycleMakeId(
                            motorhome.motor_home_make_id
                          );
                        }}
                      >
                      ...
                      <Link
                        to={`/motorhome/marks/${motorhome.motorhome_make_name}/${motorhome.motorhome_make_id}`}
                      >
