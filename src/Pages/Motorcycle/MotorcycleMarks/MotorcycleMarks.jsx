        ...
        <div className="container">
          ...
          <div className="table_wrap ">
            <AddModal
              ...
              name={"mark_name"}
              api={"motorcycle/add/mark"}
            />
            <DeleteModal
              deleteModal={deleteModal}
              setDeleteModal={setDeleteModal}
              api={"motorcycle/delete/mark"}
              id={"mark_id"}
              ...
              <tbody>
                {motorcycleList.data?.map((motorcycle, index) => (
                  <tr key={index} className="table_tr">
                    <td>{motorcycle.motorcycle_make_id}</td>
                    ...
                    <td className="btns">
                      <button
                        ...
                        onClick={() => {
                          ...
                          setSelectedMotorcycleMakeName(
                            motorcycle.motorcycle_make_name
                          );
                          setSelectedMotorcycleMakeId(
                            motorcycle.motorcycle_make_id
                          );
                        }}
                      >
                      ...
                      <Link
                        to={`/motorcycle/marks/${motorcycle.motorcycle_make_name}/${motorcycle.motorcycle_make_id}`}
                      >
...
export default MotorcycleMarks;
